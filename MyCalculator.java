...
MyOperationButton operatorButton[]=new MyOperationButton[operatorButtonText.length];  
...
{  
tempX+=WIDTH+H_SPACE;  
operatorButton[i]=new MyOperationButton(tempX,y,WIDTH,HEIGHT,operatorButtonText[i], this);  
